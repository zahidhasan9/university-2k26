...
const invoiceSchema = new Schema(
  {
    ...
    registeredCredits: { type: Number, required: true, min: 0, default: 0 },
    perCreditFeeMinor: { type: Number, required: true, min: 0, default: 0 },
    waiver: { type: Schema.Types.ObjectId, ref: "StudentWaiver" },
    waiverDescription: { type: String, trim: true, maxlength: 300 },
